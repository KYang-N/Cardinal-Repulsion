%% Using projection to estimate the drift velocity and noise coefficient of \theta
...
%%
vtheta = zeros(length(alphaRange),DynParams.NInputSample);
Dtheta = zeros(length(alphaRange),DynParams.NInputSample);
tic
