%% Search alpha and beta to investigate the bias and SD profile for the one-layer model
...
%% Define connectivity and background input
    ...
    delete(p)
    if SaveFlag 
        save('OneLayerBiasSDSearchalphasigma.mat');
    end
end
%% Visualize results
...
if LoadFlag
    clear %#ok<*UNRCH> 
    DataDir = '';
    load([DataDir,'OneLayerBiasSDSearchalphasigma.mat']);
    close
end
